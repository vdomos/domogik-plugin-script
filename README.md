# Domogik Plugin script

## Purpose

The **Script** plugin (**No xPL develop version**) is used to run Linux scripts/programs with Domogik
...
http://domogik-plugin-script.readthedocs.org/en/develop
